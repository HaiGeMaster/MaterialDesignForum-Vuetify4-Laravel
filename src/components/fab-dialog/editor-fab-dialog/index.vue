<template>
  <TemplateFabDialog :model="model" @model="model = $event;" :title="title" :appbar_extended="false" :icon="icon"
    @fullscreen="(val) => isFullscreen = val" class="vuetify-md-tiptap">
...
export default {
  ...
  data() {
    return {
      ...
      // EditorToolbarBtnSmallRule: 'default',
    }
  },
  computed: {
    model: {
    ...
    EditorToolbarBtnSmallRule() {
      ...
      // return (this.mainStore.getMobile) ? 'default' : 'small'

      // || this.isFullscreen
      return (this.screenWidth < 499) ?
        (this.screenWidth < 416 ? 'x-small' : 'small') :
        (this.isFullscreen ? 'default' : 'small');

      // if(this.screenWidth < 499) {

      // console.log('isFullscreen', this.isFullscreen)
      // if (this.mainStore.getMobile && this.screenWidth < 499) {
      //   return 'x-small'
      // } else if (this.mainStore.getMobile && this.screenWidth > 499) {
      //   return 'default'
      // } else if (!this.mainStore.getMobile && this.screenWidth > 599) {
      //   // return 'x-small'
  ...
  methods: {
    ...
    //   // console.log('isFullscreen', this.isFullscreen)
    //   if (this.mainStore.getMobile && this.screenWidth < 499) {
    //     this.EditorToolbarBtnSmallRule = 'x-small'
    //   } else if (this.mainStore.getMobile && this.screenWidth > 499) {
    //     this.EditorToolbarBtnSmallRule = 'default'
    //   } else if (!this.mainStore.getMobile && this.screenWidth > 599) {
    //     return 'x-small'
...
<!-- <style lang="scss">
@forward './styles/editor.scss';
@forward './styles//markdown.scss';
</style> -->
